                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-price">
                                        ...
                                        <a class="btn" href="/product-detail/{{$p->id}}"><i class="fa fa-shopping-cart"></i>Buy Now</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="sidebar-widget category">
                        ...
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('productos',$cat->id)}}"><i class="{{$cat->icon}}"></i>{{$cat->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </nav>
