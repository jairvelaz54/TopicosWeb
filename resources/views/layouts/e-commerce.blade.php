            ...
            <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        ...
                        <a href="{{ route('productos') }}" class="nav-item nav-link">Products</a>
                        <a href="{{ route('product_details', 1) }}" class="nav-item nav-link">Product Detail</a>
                        <a href=" {{ route('carrito') }}" class="nav-item nav-link">Cart</a>
